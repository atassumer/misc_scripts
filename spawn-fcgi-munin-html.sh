...
# Default-Stop:      0 1 6
# Short-Description: spawns the munin-html fastcgi processes
...
SCRIPTNAME=/etc/init.d/spawn-fcgi-munin-html
SSD="/sbin/start-stop-daemon" 
RETVAL=0

FCGI_DAEMON="/usr/bin/spawn-fcgi" 
FCGI_PROGRAM="/usr/lib/cgi-bin/munin-cgi-html" 
FCGI_PORT="4050" 
FCGI_SOCKET="/var/run/munin/munin-fastcgi-html.sock" 
FCGI_PIDFILE="/var/run/spawn-fcgi-munin-html.pid" 
